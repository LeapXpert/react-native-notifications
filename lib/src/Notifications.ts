...
export class NotificationsRoot {
  ...
  constructor() {
    ...
    this.commands = new Commands(this.nativeCommandsSender, this.uniqueIdProvider, this.notificationFactory)
   ...
   */
  public removeDeliveredNotificationByRoomId(roomId: string) {
    return this.commands.removeDeliveredNotificationByRoomId(roomId)
  }
